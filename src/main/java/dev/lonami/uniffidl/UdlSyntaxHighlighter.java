...
public class UdlSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey @NotNull [] getTokenHighlights(IElementType tokenType) {
        ...
        if (tokenType.equals(UdlTypes.KW_ANY)
                ...
                | tokenType.equals(UdlTypes.KW_BIGINT)
                | tokenType.equals(UdlTypes.KW_BOOLEAN)
                | tokenType.equals(UdlTypes.KW_BYTE)
                ...
                | tokenType.equals(UdlTypes.KW_LONG)
                ...
                | tokenType.equals(UdlTypes.KW_OCTET)
                ...
                | tokenType.equals(UdlTypes.KW_SHORT)
                ...
                | tokenType.equals(UdlTypes.KW_UNSIGNED)) {
            return KEYWORD_KEYS;
        }
